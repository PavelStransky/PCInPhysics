...
symplectic.plot_energy(ho, (0, 1), energy_function=ho_energy, dt=dt, maxt=maxt, integrators=[ode.euler_1, ode.euler_2, ode.runge_kutta_4])
symplectic.plot_energy(ho, (0, 1), energy_function=ho_energy, dt=dt, maxt=maxt, integrators=[ode.euler_2, ode.runge_kutta_4, symplectic.verlet, symplectic.euler_1_modified_x])
