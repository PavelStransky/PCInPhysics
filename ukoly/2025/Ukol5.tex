...
\begin{enumerate}
    \item 
        Vykreslete grafy pro $\eta=0.5$, $\omega=1$, $A=1$ a tři různé hodnoty frekvence $\omega_b=0\c2;0\c4;0\c6$. Časový interval volte $t=\langle0;500\rangle$ a počáteční podmínky $\theta_0=0,\dot{\theta}_{0}=1$.
