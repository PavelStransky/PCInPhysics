...
\subsection{Vytvoření lokálního repozitáře}
...
\subsection{Základy syntaxe Pythonu}
    Soubor se vzorovými příklady najdete ve vzdáleném repozitáři: \file{\href{https://github.com/PavelStransky/PCInPhysics2021/blob/main/Basics.py}{Basics.py}}.\footnote{
...
\subsection{Pojmenování proměnných a formátování}
    ...
    K tomu slouží komentář typu \emph{docstring}, který je vysvětlený v souboru \file{\href{https://github.com/PavelStransky/PCInPhysics2021/blob/main/Basics.py}{Basics.py}} v sekci o funkcích.
